...
#define DIAG_POP_IGNORE_OVERRIDE_INIT _Pragma("clang diagnostic pop");
#elif GNUC_PREREQ(4, 2)
#define DIAG_PUSH_IGNORE_OVERRIDE_INIT                                                             \
    _Pragma("GCC diagnostic push");                                                                \
    _Pragma("GCC diagnostic ignored \"-Woverride-init\"");
#define DIAG_POP_IGNORE_OVERRIDE_INIT _Pragma("GCC diagnostic pop");
#else
...
#define DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE _Pragma("GCC diagnostic pop");
#else
